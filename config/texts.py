...
NO_SLOTS_AVAILABLE = (
    ...
    "Достигнут лимит пользователей с активной подпиской. "
...
PROMO_SERVER_ERROR = (
    "⚠️ Не удалось активировать промокод — техническая ошибка на сервере.\n"
    "Промокод <b>не сгорел</b>, попробуйте ещё раз чуть позже или обратитесь в поддержку."
)
